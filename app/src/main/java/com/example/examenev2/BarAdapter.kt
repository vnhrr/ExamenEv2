...
class BaresAdapter(private val baresList: List<Bar>) : RecyclerView.Adapter<BaresAdapter.MyViewHolder>() {
    ...
    class MyViewHolder(view: View) : RecyclerView.ViewHolder(view) {
        ...
        var dirBar: TextView = view.findViewById(R.id.tvDireccionBar)
        var webBar: TextView = view.findViewById(R.id.tvWebBar)
        var valoBar: TextView = view.findViewById(R.id.tvValoracion)
    }
    ...
    override fun onBindViewHolder(holder: MyViewHolder, position: Int) {
        ...
        holder.dirBar.text = bar.direccion
        holder.webBar.text = bar.web_bar
        holder.valoBar.text = bar.valoracion.toString()
    }
